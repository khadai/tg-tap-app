    ...
    return (
        <Box>
            <Stack flexDirection='row' alignItems='center' gap={1.5}>
                <Box
                    sx={{border: '1.5px #03DABB solid', padding: '5px', width: 'fit-content', borderRadius: '50%'}}
                >
                    <Avatar
                        sx={{
                ...
                <Typography color='common.white' fontWeight={800} fontSize={20}>{user.name}</Typography>
            </Stack>
            ...
            <Stack flexDirection='row' gap={0.5}>
                ...
                <Box flex={1}>
                    <Stack gap={0.5}>
                        {user.videoUrls.map(url => <VideoBlock key={url.url} imageUrl={url.image}
                                                               youtubeUrl={url.url}/>)}
