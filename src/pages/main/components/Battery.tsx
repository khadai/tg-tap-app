...
const Battery: FC<Props> = () => {
    ...
    return (
        <Box bgcolor='#182724' color='primary.main' px='5px' py='2px' borderRadius={2} display='flex'
            ...
            <Stack flexDirection='row' justifyContent='space-between' width='100%' height='fit-content'
                   alignItems='center'>
                <Typography fontSize={14} fontWeight={600}>Энергия</Typography>
                <ZipperIcon/>
            </Stack>
            ...
            <div className="battery-container">
                ...
                <span className="battery-percentage">
                        <Typography fontSize={40} fontWeight={700}>{level}</Typography>
            ...
            <FormControlLabel
                ...
                control={
                    <AntSwitch size="small" checked={checked} onChange={handleChange} name="gilad"/>
                }
