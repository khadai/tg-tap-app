...
export default function InviteFriendDialog(props: SimpleDialogProps) {
    ...
    return (
        <Modal onClose={handleClose} open={open}>
            <Box display='flex' flexDirection='column' gap={1} alignItems='flex-start' sx={{
                ...containerStyle,
                borderRadius: 4,
                position: 'absolute',
                top: '50%',
                ...
                <Typography fontWeight={600} fontSize={18} textTransform='uppercase' textAlign='start'>Пригласить
                    друга</Typography>
                ...
                <Button variant='contained' fullWidth size='large'>
                    <SendInvite/>
                    <Typography fontWeight={600} fontSize={12} pl={1}
                                color={'common.white'}
                                display='inline'
                                textTransform='none'>ОТПРАВИТЬ ССЫЛКУ</Typography>
                </Button>
            </Box>
        </Modal>
    );
