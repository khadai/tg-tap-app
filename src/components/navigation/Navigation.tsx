                ...
                <Box>
                    ...
                    >
                        <BottomNavigationAction
                            label={<Typography fontSize={8} fontWeight={600}>Пригласить</Typography>}
                        ...
                        />
                        <BottomNavigationAction
                            label={<Typography fontSize={8} fontWeight={600}>Задания</Typography>}
                        ...
                        />
                        <BottomNavigationAction
                            label={<Typography fontSize={8} fontWeight={600}>Рейтинг</Typography>}
                        ...
                        />
                        <BottomNavigationAction
                            label={<Typography fontSize={8} fontWeight={600}>Награды</Typography>}
